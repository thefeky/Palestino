  ...
  return (
    <main className="w-[90%] max-w-6xl mx-auto py-10">
      ...
      <div className="flex gap-6 font-medium flex-col md:flex-row">
        <div className="w-full md:w-[30%] bg-gray-100 p-4 rounded-xl">
          ...
          <div className="pt-2 md:pt-4">
            ...
            <p className="text-gray-600">Shipping: ${shippingFee.toFixed(2)}</p>
            <p className="font-bold text-lg mt-1">Total: ${total.toFixed(2)}</p>
          </div>
        </div>

        <form className="w-full md:w-[60%] space-y-2 px-2">
          <div className="flex flex-col md:flex-row gap-4">
            <div className="w-full md:w-1/2 md:h-24">
          ...
          <div className="flex flex-col md:flex-row md:gap-4">
            ...
            <div className="w-full md:w-1/2 h-25">
